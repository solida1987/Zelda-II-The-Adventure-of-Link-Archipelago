...
Items are only placed where the game can actually show them: keys, experience
bags, jars and extra lives go anywhere, the eight key items go anywhere but the
Great Palace, and containers and quest items stay in the overworld and towns —
the palaces have no graphics for them. Items belonging to other players always
appear as a Blue Jar.
