...
**112 locations**, every one a fixed pickup somewhere in the world:

| Where | Locations |
|---|---|
| Palaces 3, 4 and 6 | 41 |
| Palaces 1, 2 and 5 | 40 |
| West Hyrule | 12 |
| East Hyrule | 12 |
| Death Mountain | 4 |
| Towns | 2 |
...
That covers the eight key items (Candle, Handy Glove, Raft, Boots, Flute,
