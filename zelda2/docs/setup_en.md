...
Leaving `experience_shuffle` off drops the experience bags, for a shorter
seed.
...
**An item another player found for me never arrived.** Items are only written
in while you are actually in the game -- anything sent while you are on the
title screen waits and lands right after you load your file.
